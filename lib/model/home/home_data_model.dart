...
class HomeTitleModel{
  ...
  const HomeTitleModel({
    required this.titleNumber, // 机台序号
    required this.titleCustomerModel, //客户型号
    required this.titleProductSpecification, //产品规格
    required this.titleProcessing, //加工工序
    required this.titleDailyOutput, // 当天产量
    required this.titleNumberChanges, // 换机次数
    required this.titleChief, //负责人
    required this.titleQualityInspector, //质检员
    required this.titleRemarks, //备注
  });
